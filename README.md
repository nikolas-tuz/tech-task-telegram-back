...
- Не встиг зробити нормальну пагінацію й адаптив;  - фетчу перших 140 чатів й до 80 повідомлень кожного чату. Для збереження часу було зроблено саме так. Я вже й
